    ...
    <div class="container-fluid bg-light-gray m-0 p-0 pb-5">
        <div class="container m-0 p-0 mx-auto advice-to-customers mt-5 mb-3 box-block">
            <div class="p-3 pb-5 pt-2">
                <h2 class="p-3">Update Notification</h2>
                <Form :model="updateNotificationData" v-if=" updateNotificationData !== null">
                    <div class="row m-0 p-0">
                        <div class="col-md-6 mb-3 gray-input">
                            <p>Title</p>
                            <Input v-model="updateNotificationData.title" placeholder="please enter title of notification" />
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <wysiwyg v-model="updateNotificationData.content" placeholder="please enter description" />
                        </div>
                        <div class="col-12 text-left d-flex justify-content-start mt-3 position-relative">
                            ...
                            <Button icon="md-create" type="success" class="ml-auto" @click="updateNotification" :disabled="isUpdating" :loading="isUpdating">Update</Button>
                        </div>
