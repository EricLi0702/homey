                    ...
                    <div class="posted-item" v-for="(notification,i) in notificationList" :key="i" v-if="notificationList.length">
                        <div class="pi-wrap float-left">
                            <div class="user-info float-left">
                                ...
                                <div class="icons">
                                    <Icon v-if="notification.type.includes('common')" size="21" type="md-hand" color="#BFD23A"/>
                                    <Icon v-if="notification.type.includes('urgent')" size="21" type="md-stopwatch" color="#F4B894" />
                                    <Icon v-if="notification.type.includes('important')" size="21" type="ios-warning-outline" color="#F26A5A" />
                                </div>
                            </div>
