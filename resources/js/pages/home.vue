        ...
        <div class="hero-items row">
            <div class="container">
                <div class="row align-middle">
                  <router-link :to="{ name: 'notification' }" class="col-6 col-sm-6 col-md-6 col-lg-4 column" >
    ...
    <div class="container-fluid mt-5">
        <div class="row p-0 m-0">
            <div class="add-title col-md-12 row p-0 m-0">
                <h2 class="col-md-12 d-flex align-items-center justify-content-center row p-0 m-0 text-warning">{{$t('welcome').ApartmentLiving}}</h2>
            </div>
